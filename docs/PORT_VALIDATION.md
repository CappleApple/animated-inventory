...
Validated on **September 19, 2026** with **NeoForge 26.3.0.6-beta** and **Java 25**. Loader and build versions are pinned; see the [README](../README.md).

| Check | Result | Evidence |
| --- | --- | --- |
| Unit tests | 100 passed; no failures, errors or skips | [Suite counts](evidence/ports/unit-tests.json) |
| Client fixture | Passed | [Report](evidence/ports/neoforge-26.3-client.txt) |
| Dedicated server | Passed | [Report](evidence/ports/neoforge-26.3-server.txt) |
