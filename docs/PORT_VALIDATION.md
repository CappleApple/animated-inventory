...
Validated on **September 19, 2026** with **Fabric 0.19.5** and **Java 17**. Loader and build versions are pinned; see the [README](../README.md).

| Check | Result | Evidence |
| --- | --- | --- |
| Unit tests | 95 passed; no failures, errors or skips | [Suite counts](evidence/ports/unit-tests.json) |
| Client fixture | Passed | [Report](evidence/ports/fabric-1.20.1-client.txt) |
...
Unit coverage includes transaction inference, animation ownership and crafting flow. The legacy JEI packet discriminator is tested without consuming its buffer.
