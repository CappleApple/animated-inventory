...
Validated on **September 19, 2026** with **NeoForge 26.2.0.88** and **Java 25**. Loader and build versions are pinned; see the [README](../README.md).

| Check | Result | Evidence |
| --- | --- | --- |
| Unit tests | 100 passed; no failures, errors or skips | [Suite counts](evidence/ports/unit-tests.json) |
| Client fixture | Passed | [Report](evidence/ports/neoforge-26.2-client.txt) |
| Dedicated server | Passed | [Report](evidence/ports/neoforge-26.2-server.txt) |
...
The dedicated server started with the mod present, reached 40 ticks and shut down cleanly. This checks server loading behavior, not multiplayer gameplay.
