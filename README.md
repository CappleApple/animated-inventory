...
This branch builds **version 1.1.1 for Minecraft 1.20.1 Fabric**. The original NeoForge 1.21.1 version remains on `main`.

## Installation

Minecraft **1.20.1**, **Fabric 0.19.5**, and **Java 17**. The required Fabric resource loader module (`0.11.12+fb82e9d777`) is bundled. A separate Fabric API installation is optional. Install `animatedinventory-fabric-1.20.1-1.1.1.jar` in the client's `mods` directory. A server installation is not required.
...
The installable jar is `build/libs/animatedinventory-fabric-1.20.1-1.1.1.jar`. Source jars are for development.
