...
This branch builds **version 1.1 for Minecraft 26.2 Fabric**. The original NeoForge 1.21.1 version remains on `main`.

## Installation

Minecraft **26.2**, **Fabric 0.19.5**, and **Java 25**. Fabric API is not required. Install `animatedinventory-fabric-26.2-1.1.jar` in the client's `mods` directory. A server installation is not required.
...
The installable jar is `build/libs/animatedinventory-fabric-26.2-1.1.jar`. Source jars are for development.
