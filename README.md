...
Native rendering preserves item decorations and vanilla drag-preview quantities. Stack matching includes Minecraft 1.21.1 data components.
...
Use **JDK 21** to run the build. The wrapper pins **Gradle 8.14.3** and the build uses **Fabric Loom 1.11.8**. The Java toolchain compiles for Java 21.
